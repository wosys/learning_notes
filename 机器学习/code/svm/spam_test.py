...
# 垃圾邮件分类器
data = loadmat(r'ML\SVM\data_email\spamTrain.mat')
X = np.mat(data['X'])
y = data['y']
m, n = X.shape
C = 0.1
...
# 使用测试集评估训练结果
data = loadmat(r'ML\SVM\data_email\spamTest.mat')
...
files = [
    'ML\SVM\data_email\emailSample1.txt',
    'ML\SVM\data_email\emailSample2.txt',
    'ML\SVM\data_email\spamSample1.txt',
    'ML\SVM\data_email\spamSample1.txt'
]
