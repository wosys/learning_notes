# 学校文印室，U盘插入电脑后会出现文件及文件夹消失，但是会生成与原文件及文件夹同名的exe文件
# 这些生成的exe文件多为病毒文件，点击之后计算机可能会感染病毒

# 恢复U盘内原文件及文件夹，并删除病毒文件

# 原项目：https://github.com/FrankZhangX/recover_hidden_files
