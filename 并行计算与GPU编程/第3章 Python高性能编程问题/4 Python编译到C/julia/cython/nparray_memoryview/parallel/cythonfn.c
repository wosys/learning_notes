      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_10, __pyx_t_11, __pyx_t_12, __pyx_t_3, __pyx_t_8, __pyx_t_9)
            #endif /* _OPENMP */
            {
 ...
 */
                                while (1) {
                                  __pyx_t_3 = __pyx_v_i;
                                  __pyx_t_12 = (((*((int *) ( /* dim=0 */ (__pyx_v_output.data + __pyx_t_3 * __pyx_v_output.strides[0]) ))) < __pyx_v_maxiter) != 0);
                                  if (__pyx_t_12) {
                                  } else {
                                    __pyx_t_11 = __pyx_t_12;
                                    goto __pyx_L16_bool_binop_done;
                                  }
                                  __pyx_t_12 = ((((__Pyx_CREAL(__pyx_v_z) * __Pyx_CREAL(__pyx_v_z)) + (__Pyx_CIMAG(__pyx_v_z) * __Pyx_CIMAG(__pyx_v_z))) < 4.0) != 0);
                                  __pyx_t_11 = __pyx_t_12;
 ...
 *     cdef unsigned int i, length
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_8cythonfn_1calculate_z, NULL, __pyx_n_s_cythonfn); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
